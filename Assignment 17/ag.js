...
var places = ['Tokyo', 'Amazon', 'Antarctica', 'Atacama Desert', 'Banff National Park', 'Cappadocia', 'Etretat', 'Finnish Lapland'];
...
console.log(__spreadArray([], places, true).sort(function (a, b) { return b.localeCompare(a); }));
console.log("\nIn Original order\n");
console.log(places);
